package com.example.multi_module.post;

import com.example.multi_module.post.adapter.out.config.QuerydslConfig;
import com.example.multi_module.post.adapter.out.persistence.entity.PostEntity;
import com.example.multi_module.post.adapter.out.persistence.repository.PostRepository;
